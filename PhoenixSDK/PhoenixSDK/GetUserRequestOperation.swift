...
internal final class GetUserRequestOperation : UserRequestOperation {
    ...
    required init(userId: Int, oauth: PhoenixOAuthProtocol, configuration: Phoenix.Configuration, network: Network, callback: PhoenixOAuthCallback) {
        self.userId = userId
        super.init(oauth: oauth, configuration: configuration, network: network, callback: callback)
    }

    required init(user: Phoenix.User?, oauth: PhoenixOAuthProtocol, configuration: Phoenix.Configuration, network: Network, callback: PhoenixOAuthCallback) {
