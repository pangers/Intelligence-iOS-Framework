...
//    }
    ...
    func testValidateSuccess() {
        ...
        intelligence?.identity?.login(with: fakeUser.username, password: fakeUser.password!, callback: { (_, error) -> Void in
    ...
    func testLoginLogoutSuccess() {
        ...
        intelligence?.identity.login(with: fakeUser.username, password: fakeUser.password!) { (user, error) -> Void in
    ...
    func testLoginSuccessGetMeFailure() {
        ...
        intelligence?.identity.login(with: "username", password: "password") { (user, error) -> Void in
    ...
    func testLoginSuccessParseError() {
        ...
        intelligence?.identity.login(with: "username", password: "password") { (_, error) -> Void in
            XCTAssert(error?.code == RequestError.parseError.rawValue)
...
//    }
    ...
    func testCreateIdentifierInvalidDeviceTokenError() {
        ...
        identity!.registerDeviceToken(with: Data()) { (_, error) -> Void in
            XCTAssert(error != nil)
